...
// from filling. It filled twice (June 14 and 17, 2026); at ~110k rows/day, 3
// days holds stop_events near 45MB and still gives the rollup two full days to
// catch up after an outage before a day is pruned.
